...
export const registerUser = async (user, dispatch, navigate) => {
  ...
  try {
    await axios.post(apiLinks.Auth.SIGNUP, user);
...
export const fetchAllUsers = async (dispatch, token) => {
  ...
  try {
    const response = await axios.get(apiLinks.User.GET_USERS, {
...
export const fetchUnlockHistory = async (token, dispatch) => {
  ...
  try {
    const response = await axios.get(apiLinks.User.ALL_HISTORY, {
      headers: { Authorization: `Bearer ${token}` },
    });
...
export const deleteUser = async (userId, token, dispatch) => {
  ...
  try {
    const response = await axios.delete(apiLinks.User.DELETE_USER, {
      headers: {
...
export const fetchFailedAttemptImages = async (dispatch, token) => {
  ...
  try {
    const response = await axios.get(apiLinks.User.IMAGE, {
      headers: { Authorization: `Bearer ${token}` },
    });
...
export const fetchCloseHistory = async (token, dispatch) => {
  ...
  try {
    const response = await axios.get(apiLinks.User.CLOSE_TIME, {
      headers: { Authorization: `Bearer ${token}` },
    });
...
export const fingerHistory = async (token, dispatch) => {
  ...
  try {
    const response = await axios.get(apiLinks.User.GET_FINGER_HISTORY, {
      headers: { Authorization: `Bearer ${token}` },
    });
